...
public class TabDFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_tab_d, container, false);

        webView = view.findViewById(R.id.webviewTabD);
        ...
        // Load URL websitemu
        webView.loadUrl("https://kp-dyesablon-kingastro.vercel.app/"); // ganti dengan URL-mu
